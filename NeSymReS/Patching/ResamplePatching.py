...
# Load data
data_name = f"/home/arco/Downloads/Master/MscThesis/ExplainableDSR/data/Arco/ResamplePatching/cached_values_{100}_{OPERATION}_cos_TRAIN.npz"
...
encoders = prepare_encoders(names, [], mean_patches, "resample", model, Xs, ys)
...
for idx in tqdm(range(0, 117)):
    encoders = prepare_encoders(names, [idx], mean_patches, "resample", model, Xs, ys)
...
num = len(dataset)
save_name = f'data/Arco/MeanPatching/results_RESAMPLE_{OPERATION}_{num}.npy'
